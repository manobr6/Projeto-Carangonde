...
import imgcidadania from '/src/assets/cidadania.png'
import imgconstrucao from '/src/assets/construcao.png'
import imgregulairzacao from '/src/assets/regulairzacao.png'
import imgcurso from '/src/assets/curso.png'
import imgmenu from '/src/assets/construindocidadania.png'
import imgvistapraia from '/src/assets/vistapraia.png'
import './options.css'
...
function OPTIONS(){
    return(
        <section>
        <div>
            <img src={imgmenu} alt="Construindo Cidadania" id='imgmenu'/>
